...
bool JPEGCamera::imageSize2(JPEGCamera::ImageSize size)
{
    cmdResBuffer[0] = 0x56;
    cmdResBuffer[1] = 0x00;
    cmdResBuffer[2] = 0x54;
    cmdResBuffer[3] = 0x01;
    cmdResBuffer[4] = (uint8_t)size;
    return commandAndResponse(5, 5);
}

bool JPEGCamera::changeBaudRate(int baudrate)
{
    cmdResBuffer[0] = 0x56;
    cmdResBuffer[1] = 0x00;
    cmdResBuffer[2] = 0x24;
...
//pre: Serial2 is a serial connection to the camera set to 38400 baud
...
uint8_t JPEGCamera::commandAndResponse(uint8_t cmd_sz,uint8_t res_sz)
{
    ...
    Serial2.write(cmdResBuffer, cmd_sz);
